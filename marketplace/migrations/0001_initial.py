# Generated by Django 5.0.4 on 2024-04-18 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orgName', models.CharField(max_length=200, verbose_name='Org Name')),
                ...
                ('catAddedToAssortment', models.BooleanField(verbose_name='Added to system?')),
                ('catIsActive', models.BooleanField(verbose_name='Is active?')),
                ('catLastModified', models.CharField(max_length=200)),
                ('catNote', models.CharField(max_length=200, verbose_name='Note')),
            ],
        ),
        migrations.CreateModel(
            name='AttributeValue',
